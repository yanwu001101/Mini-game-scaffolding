...
export default class AdSdkVivoApk extends AdSDK {
    ...
    dataLoadComplete() {
        this.adData = this.m_adSdkData.vivoApk;
        ...
        this.m_mediaId = this.adData.mediaId;
        ...
        console.log("vivoApk广告参数：" + + JSON.stringify(this.adData));
        this.initPlatformSdk();
    }


    initPlatformSdk() {
        Native.initBUAdSDK(this.AppId, this.m_mediaId);
    }
